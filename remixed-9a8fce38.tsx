...
const MoleculeStudio = () => {
  ...
  const translateToEnglish = async (hebrewText) => {
    try {
  ...
  const getPubChemCID = async (moleculeName) => {
    try {
  ...
  const getPubChem3DStructure = async (cid) => {
    try {
  ...
  const parseSDF = (sdfData, formula, cid) => {
